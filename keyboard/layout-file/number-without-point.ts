const numberWithoutPoint = {
  'normal': {
    ...
    'KeyCodes': [
      ...
      [
        { 'key': '0', 'row': '3', 'col': '0', 'colspan': '6' },
        { 'key': '{toggle}', 'row': '3', 'col': '6', 'colspan': '2' }
      ]
    ]
  }
};
export default numberWithoutPoint;
